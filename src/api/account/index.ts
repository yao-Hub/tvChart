...
enum Api {
  ...
  QueryTradeLine = "/admin-api/server/queryTradeLine",
  Register = "/admin-api/my/sign_up",
  QueryNode = "/admin-api/server/queryNode",
  VirtualLine = "/admin-api/my/virtual_line_query",
  EmailPasswordUpdate = "/admin-api/my/email_password_update",
  SendEmail = "/admin-api/my/sendEmail",
  ArticleDetails = "/admin-api/column/select_trade_column",
  ProtocolAgree = "/admin-api/protocol/protocol_agree",
